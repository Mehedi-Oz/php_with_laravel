                ...
                <div class="col-lg-6">
                    <div class="search-wrapper">
                        ...
                        <div class="sidebar-icon">
                            <button class="sidebar-btn"><i class="fa-solid fa-circle-user"></i></button>
                        </div>
                    </div>
                </div>
              ...
              <span class="navbar-toggle" id="navbar-toggle">
                <i class="fas fa-bars"></i>
                   ...
                   <span class="right-bar"></span></span></a>
                    ...
                    <span class="right-bar"></span></span></a>
                            <ul class="drop-menu">
                                <li class="drop-menu-item"><a href="archive-layout-one.html">Archive Layout One</a>
                                </li>
                                <li class="drop-menu-item"><a href="archive-layout-two.html">Archive Layout Two</a>
                                </li>
                                ...
                                <li class="drop-menu-item"><a href="archive-layout-four.html">Archive Layout
                                        Four</a></li>
                                <li class="drop-menu-item"><a href="single-layout-one.html">Single Layout One</a>
                                </li>
                                <li class="drop-menu-item"><a href="single-layout-two.html">Single Layout Two</a>
                                </li>
                                <li class="drop-menu-item"><a href="single-layout-three.html">Single Layout
                                        Three</a></li>
                                <li class="drop-menu-item"><a href="single-layout-four.html">Single Layout Four</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="sticky-sidebar-content">
            ...
            @if(Session::get('customerId'))
                ...
                <div class="circular-icons social-links">
                    <ul>
                        <a href="{{route('logout.customer')}}" class="btn btn-danger btn-sm">Logout</a>
                    </ul>
                </div>
            @else
                <h3>Sign Up</h3>
